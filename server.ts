    ...
    open(ws) {
      ...
      ws.send(JSON.stringify({
        ...
        data: {
          ...
          messages: chatManager.getRecentMessages(50),
...
function handleWebSocketMessage(ws: ServerWebSocket<any>, data: any) {
  ...
  switch (event) {
    ...
    case 'send_message':
      ...
      const message = chatManager.addMessage(senderId, payload.text)
      if (message) {
